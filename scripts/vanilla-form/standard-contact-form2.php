...
define('FROM_EMAIL', 'noreply@everythingbagel.com');

// Recipient's e-mail. To this e-mail messages will be sent.
// e.g.: john@example.com
// multiple recipients e.g.: john@example.com, andy@example.com
define('TO_EMAIL', 'etsbagels@yahoo.com, cf@frascadesigngroup.com, cs@frascadesigngroup.com');
...
function sendMessage() {
     ...
     */
    $title = 'Everything Bagel Website - New Message from '.$contact_name;
    $message = 'Hey,'."\n\n"
